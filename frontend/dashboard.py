...
API_URL = "https://nexusid-api.onrender.com"
...
# ---------------------------
st.markdown(
    '<div class="main-title">🏛️ NexusID – National Business Identity System</div>',
    unsafe_allow_html=True
)
...
if menu == "UBID Matching":
    ...
    st.markdown(
        '<div class="section-title">Entity Matching & UBID Generation</div>',
        unsafe_allow_html=True
    )
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if decision == "AUTO-MERGE":
                    st.markdown(
                        '<span class="badge badge-success">AUTO-MERGE</span>',
                        unsafe_allow_html=True
                    )
                ...
                if decision == "AUTO-MERGE":
                    ...
                    ubid = (
                        f"UBID-"
                        f"{st.session_state['id1']}"
                        f"{st.session_state['id2']}"
...
# ---------------------------
    ...
    st.markdown(
        '<div class="section-title">Human Review & Decision Console</div>',
        unsafe_allow_html=True
    )
...
# ---------------------------
    ...
    st.markdown(
        '<div class="section-title">Business Activity Intelligence</div>',
        unsafe_allow_html=True
    )
...
# ---------------------------
    ...
    st.markdown(
        '<div class="section-title">Business Intelligence Query Engine</div>',
        unsafe_allow_html=True
    )
